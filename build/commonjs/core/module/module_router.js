...
var ModuleRouter = /** @class */ (function () {
    ...
    ModuleRouter.prototype.forward = function (targetIdentifier, parcel) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                moduleName = s[1];
                target = ContainerManager.getInstance().getContainer(targetContainerId);
    ...
    ModuleRouter.prototype.back = function (targetContainerId) {
        var target = ContainerManager.getInstance().getContainer(targetContainerId);
        target.back();
    };
...
//# sourceMappingURL=module_router.js.map