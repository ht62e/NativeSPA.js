...
define("core/container/page_container", ["require", "exports", "core/container/container", "core/common/runtime_error", "core/common/dto", "core/module/module_manager"], function (require, exports, container_1, runtime_error_1, dto_1, module_manager_1) {
    ...
    var PageContainer = /** @class */ (function (_super) {
        ...
        PageContainer.prototype.jump = function (moduleName, parcel, withoutTransition) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        PageContainer.prototype.prepareModule = function (moduleName) {
            return __awaiter(this, void 0, void 0, function () {
                var availableModule, moduleList, i, moduleManager;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, moduleManager.loadModuleRecursively(moduleName)];
                        case 1:
                        ...
                        return [2 /*return*/, availableModule];
                    }
                });
            });
        };
...
define("core/container/flat_container", ["require", "exports", "core/container/container", "core/common/runtime_error"], function (require, exports, container_2, runtime_error_2) {
    ...
    var FlatContainer = /** @class */ (function (_super) {
        ...
        FlatContainer.prototype.forward = function (moduleName, parcel) {
            return __awaiter(this, void 0, void 0, function () {
                var module;
                return __generator(this, function (_a) {
                    module = this.mountedModules.get(moduleName)[0];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, moduleManager.loadModuleRecursively(overlayName)];
                        case 1:
                            _a.sent();
...
define("core/module/module_manager", ["require", "exports", "core/module/plain_html_module", "core/common/runtime_error"], function (require, exports, plain_html_module_1, runtime_error_5) {
    ...
    var ModuleManager = /** @class */ (function () {
        ...
        ModuleManager.prototype.registerDescription = function (moduleName, sourceUri, displayMode, targetContainerId, isContainerDefault, options) {
            var op = options || {};
            var ds = {
        ...
        ModuleManager.prototype.fetchModule = function (moduleName) {
            return __awaiter(this, void 0, void 0, function () {
                var module, description;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
